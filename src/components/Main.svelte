<script>
  ...
  let benefits = [
    ...
    {name: 'a product design & UX finatic', description: "Carefully crafting and designing amazing user experiences allows me to express and experiment with every morsel of creativity I have. I love the challenge of learning new design concepts and enabling users with amazing online experiences."},
    {name: 'an excellent communitator', description: "Communication is key and it's a paramount value of mine. I believe in transparency and constructive communication above all else. This helps me develop deep relationships and ensures my effectiveness and productivity in any work space with any team."}
  ];
</script>
...
<main class="flex flex-col flex-1 p-4">
  ...
  >
    ...
    >
      <h2 class="font-semibold text-4xl sm:text-5xl md:text-6xl">
        Hi! I'm <span class="poppins text-violet-400">Angelika</span> Pawluk
        <br />Full Stack
  ...
  <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
    ...
    <a
      href="https://www.youtube.com/watch?v=-2UjwQzxvBQ"
      target="_blank"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-10">
      <Step step={steps[0]}>
        <p>
          Smoljames Store is a a merchandising store created with <strong
    ...
    <table class="bg-white text-slate-700 rounded text-center">
        ...
        <tbody>
            ...
            <tr class="border-b border-solid border-slate-200">
                ...
                <td><i class="fa-solid fa-check text-slate-500"></i></td>
                <td><i class="fa-solid fBa-check text-slate-500"></i></td>
                <td><i class="fa-solid fa-xmark text-slate-500"></i></td>
                <td><i class="fa-solid fa-check text-green-500"></i></td>
            </tr>
        </tbody>
