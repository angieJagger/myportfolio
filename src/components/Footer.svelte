<footer class="py-20 sm:py-32 bg-black border-t border-solid border-violet-950 flex flex-col gap-4 sm:gap-8 justify-center items-center">
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p><strong class="pr-2">Email</strong>angelika.pawluk94@gmail.com</p>
        <p><strong class="pr-2">Github</strong>
        <a href="#" class="text-violet-400" target="_blank">angieJagger<sup><span class="text-xs scale-75 pl-0.5">
            <i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"/>
        </span></sup></a>
        </p>
        <p><strong class="pr-2">LinkedIn</strong>
        <a href="#" class="text-violet-400" target="_blank">angieJagger<sup><span class="text-xs scale-75 pl-0.5">
            <i class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"/>
        </span></sup></a>
        </p>
